...
export default function NavBar() {
  ...
  return (
    <div className="w-20 lg:w-56 2xl:w-80 border-r border-gray-500">
      <nav className="fixed flex flex-col h-screen p-3">
        ...
        <ul className="flex flex-1 flex-col">
          {navItems.map((item) => {
            return (
              <li
              className="h-12 text-lg flex items-center mt-1 mb-1 hover:bg-slate-200 active:bg-slate-300 rounded-md w-12 lg:w-full"
              key={item.name}>
